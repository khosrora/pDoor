...
function Footer() {
  ...
  return (
    <div>
      <footer className="footer sm:footer-horizontal bg-[#005E8B] p-10 text-white">
        {/* Column: About */}
        <nav>
      ...
      {/* Bottom bar */}
      <div className="footer footer-horizontal footer-center bg-[#003148] p-10 text-white">
        <nav>
