...
import PrivateSlider from "@/app/components/pages/PrivateSlider";

export const metadata: Metadata = {
  title: "پرشیادُر | مراکز خصوصی",
  description:
...
export default async function PrivateCenterPage() {
  const t = await getTranslations("PrivatePage");
