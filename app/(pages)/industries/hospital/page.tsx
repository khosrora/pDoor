    ...
    <div className="my-20">
      ...
      <div className="max-w-5xl m-auto">
        ...
        <div className="p-4">
          ...
          {/* Card 1: Hygiene */}
          <div className="bg-zinc-100 lg:h-[250px]  rounded-md flex justify-between items-center gap-x-2 p-4 mt-8">
            ...
            <div className="bg-white rounded-md p-4 text-xs lg:w-full lg:h-[196px] p-8">
              <p className="text-[#003F5D] font-bold lg:text-[20px]">
                {t("benefits.hygiene.title")}
              </p>
              <p className="mt-4 lg:text-[16px]">
